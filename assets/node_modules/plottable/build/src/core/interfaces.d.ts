 ...
 */
export declare type Projector = (datum: any, index: number, dataset: Dataset) => any;
/**
 * A mapping from attributes ("x", "fill", etc.) to the functions that get
 * that information out of the data.
 */
export declare type AttributeToProjector = {
 ...
 */
export declare type AppliedProjector = (datum: any, index: number) => any;
/**
 * A mapping from attributes to the AppliedProjectors used to generate them.
 */
export declare type AttributeToAppliedProjector = {
 ...
 */
export declare type SpaceRequest = {
    minWidth: number;
    minHeight: number;
};
/**
