 ...
 */
export declare type SymbolFactory = (symbolSize: number) => string;
...
export declare function triangleUp(): SymbolFactory;
export declare function triangleDown(): SymbolFactory;
