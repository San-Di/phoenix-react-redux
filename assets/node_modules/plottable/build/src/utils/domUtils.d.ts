 ...
 */
export declare function elementBBox(element: d3.Selection<any>): SVGRect;
/**
 * Screen refresh rate which is assumed to be 60fps
 */
export declare var SCREEN_REFRESH_RATE_MILLISECONDS: number;
/**
 ...
 */
export declare function elementWidth(element: Element): number;
/**
 ...
 */
export declare function elementHeight(element: Element): number;
/**
 ...
 */
export declare function translate(selection: d3.Selection<any>): [number, number];
/**
 ...
 */
export declare function translate(selection: d3.Selection<any>, x: number, y: number): d3.Selection<any>;
/**
 ...
 */
export declare function boundingSVG(element: SVGElement): SVGElement;
/**
 * Generates a ClipPath ID that is unique for this instance of Plottable
 */
export declare function generateUniqueClipPathId(): string;
/**
