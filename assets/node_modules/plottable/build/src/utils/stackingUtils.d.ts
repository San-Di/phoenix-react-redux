 ...
 */
export declare type IStackingOrder = "topdown" | "bottomup";
 ...
 */
export declare function stack(datasets: Dataset[], keyAccessor: Accessor<any>, valueAccessor: Accessor<number>, stackingOrder?: IStackingOrder): StackingResult;
/**
 ...
 */
export declare function stackedExtent(stackingResult: StackingResult, keyAccessor: Accessor<any>, filter: Accessor<boolean>): number[];
/**
